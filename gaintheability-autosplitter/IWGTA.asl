state("I wanna gain the ability")
{
    ...
    double deaths       : 0x00445C40, 0x60, 0x10, 0x1E4, 0x5E0;
    double seconds      : 0x00445C40, 0x60, 0x10, 0x1E4, 0x5D0;
    double microseconds : 0x00445C40, 0x60, 0x10, 0x1E4, 0x5C0;
    string32 saveRoom   : 0x00445C40, 0x60, 0x10, 0x1E4, 0x5B0, 0x0, 0x0;
    ...
    double machine : 0x00445C40, 0x60, 0x10, 0x1E4, 0x530; // boss 1
    // double gunface : 0x00445C40, 0x60, 0x10, 0x1E4, 0x430; // stage 2-2 - after one room after mb
    double chase   : 0x00445C40, 0x60, 0x10, 0x1E4, 0x540; // boss 2-1
    double core    : 0x00445C40, 0x60, 0x10, 0x1E4, 0x520; // boss 2-2
    double ena     : 0x00445C40, 0x60, 0x10, 0x1E4, 0x3F0; // final boss

    // there's only 6 items i'm not bothering with bytearrays
    double filth        : 0x00445C40, 0x60, 0x10, 0x5BC, 0x0, 0x4, 0xC, 0x90;
    double death        : 0x00445C40, 0x60, 0x10, 0x5BC, 0x0, 0x4, 0xC, 0xA0;
    double purpleGem    : 0x00445C40, 0x60, 0x10, 0x5BC, 0x0, 0x4, 0xC, 0xB0;
    double blueGem      : 0x00445C40, 0x60, 0x10, 0x5BC, 0x0, 0x4, 0xC, 0xC0;
    double greenGem     : 0x00445C40, 0x60, 0x10, 0x5BC, 0x0, 0x4, 0xC, 0xD0;
    double redGem       : 0x00445C40, 0x60, 0x10, 0x5BC, 0x0, 0x4, 0xC, 0xE0;
}
